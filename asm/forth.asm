...
;
FCO	EQU	KBBUF+4	; DISK BUFFER + 2 HEADER + 2 TAIL
NBUF	EQU	NSCR*400H/KBBUF	; NUMBER OF BUFFERS
BUF1	EQU	EM-FCO*NBUF	; ADDR FIRST DISK BUFFER
...
OLDCIN:	CALL	IOCHK
	...
	RET		; WAIT FOR CHR TO BE TYPED, (A) <- CHR, (MSB) <- 0
CIN1:	CALL	RI
	RET
...
OLDCOUT:	CALL	IOCHK
	ANI	03H
	JZ	COUT1
	CALL	CO	; CONSOLE OUTPUT CHAR IN (C)
	RET
COUT1:	CALL	PO
	RET
